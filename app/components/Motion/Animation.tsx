...
export const AnimateRight = ({children, delay, className, width = "fit-content"} : RevealProps) => {
  ...
  return (
    <div ref={ref} className={`relative overflow-hidden h-full ${width} ${className}`}>
...
export const AnimateZoomIn = ({children, delay, width = "fit-content", className} : RevealProps) => {
